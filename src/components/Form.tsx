  ...
  return (
    <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
      <div className="flex flex-col">
        ...
        />
      {errors?.name && (
        <small className="text-xs text-red-600 mt-1">{errors?.name}</small>
      )}
      ...
      <div className="flex flex-col">
        ...
        />
        {errors?.email && (
        <small className="text-xs text-red-600 mt-1">{errors?.email}</small>
      )}
      ...
      <div className="flex gap-2 items-center">
        ...
        {errors?.agree && (
        <small className="text-xs text-red-600 mt-1">{errors?.agree}</small>
      )}
      </div>
